...
- **p = 43** — `results/cube_p43_template.txt` — **constructed, not searched**:
  predicted from the §7 rule, then three small decoupled solves. The block
  model gets no verdict at 43 in 4 × 2400 s.
...
| 43 | targeted hit at sig (0,1,1,2,2,1), v = 7, swap = 0 | — |

The rule now holds at **13, 19, 31, 37, 43**.
